...
import { fallbackPersonImage, fechtPersonDetails, fechtPersonMovies, image342 } from '../api/moviedb';
...
export default function PersonScreen() {
    ...
    const getPersonMovies = async id=>{
        const data = await fechtPersonMovies(id);
            ...
            loading? (
                ...
                <View>
                    ...
                    <View className="mx-3 p-4 mt-6 flex-row justify-between items-center bg-neutral-700 rounded-full">
                        ...
                        <View className="border-r-2 border-r-neutral-400 px-2 items-center text-center">
